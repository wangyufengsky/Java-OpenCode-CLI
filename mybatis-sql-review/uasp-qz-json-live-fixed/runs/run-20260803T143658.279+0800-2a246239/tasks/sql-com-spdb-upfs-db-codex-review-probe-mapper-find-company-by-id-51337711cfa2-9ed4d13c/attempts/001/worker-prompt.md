...
```json
{
  "statement_key" : "com-spdb-upfs-db-codex-review-probe-mapper-find-company-by-id-51337711cfa2",
  ...
  "statement_id" : "findCompanyById",
  "command_type" : "select",
  "select_key" : false,
  "source_start_line" : 34,
  "source_end_line" : 40,
  "raw_mapper_xml" : "<select id=\"findCompanyById\" parameterType=\"java.lang.Integer\"\n            resultMap=\"CompanyResultMap\">\n        SELECT\n        <include refid=\"CompanyColumns\"/>\n        FROM COMPANY\n        WHERE ID = #{id,jdbcType=INTEGER}\n    </select>",
  "normalized_sql" : "SELECT\n        \n        ID,\n        COMPANY_NAME,\n        COMPANY_STATE,\n        COMPANY_CITY,\n        EMPLOYEE,\n        COMPANY_CREATE_YEAR\n    \n        FROM COMPANY\n        WHERE ID = #{id,jdbcType=INTEGER}",
  "dynamic_nodes" : [ ],
  "parameter_placeholders" : [ "#{id,jdbcType=INTEGER}" ],
  ...
  "candidate_directory" : "/Users/wangyufeng/IdeaProjects/Java-OpenCode-CLI/mybatis-sql-review/uasp-qz-json-live-fixed/runs/run-20260803T143658.279+0800-2a246239/tasks/sql-com-spdb-upfs-db-codex-review-probe-mapper-find-company-by-id-51337711cfa2-9ed4d13c/attempts/001/candidate",
  "report_path" : "/Users/wangyufeng/IdeaProjects/Java-OpenCode-CLI/mybatis-sql-review/uasp-qz-json-live-fixed/runs/run-20260803T143658.279+0800-2a246239/tasks/sql-com-spdb-upfs-db-codex-review-probe-mapper-find-company-by-id-51337711cfa2-9ed4d13c/attempts/001/candidate/report.md",
  "summary_path" : "/Users/wangyufeng/IdeaProjects/Java-OpenCode-CLI/mybatis-sql-review/uasp-qz-json-live-fixed/runs/run-20260803T143658.279+0800-2a246239/tasks/sql-com-spdb-upfs-db-codex-review-probe-mapper-find-company-by-id-51337711cfa2-9ed4d13c/attempts/001/candidate/summary.json",
  "database_evidence_path" : "/Users/wangyufeng/IdeaProjects/Java-OpenCode-CLI/mybatis-sql-review/uasp-qz-json-live-fixed/runs/run-20260803T143658.279+0800-2a246239/tasks/sql-com-spdb-upfs-db-codex-review-probe-mapper-find-company-by-id-51337711cfa2-9ed4d13c/attempts/001/candidate/database-evidence.json"
}
```
