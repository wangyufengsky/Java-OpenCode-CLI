  ...
  const chainConfigDefinitions = {
    ...
    'mybatis-sql-review': {
      ...
      fields: [
        ...
        field('agentbridge.mcp-url', 'AgentBridge MCP URL', '应用预检和 review agent 都通过 AgentBridge MCP 调用 AgentBridge Custom MCP 注册的数据库工具；默认 http://127.0.0.1:8643/mcp。', 'text', 'agentbridge', true),
