...
- `index.md` 和 `summary.md` 已由准备脚本预创建为完整模板；主 agent 使用 `index_inputs.output.index_md`、`index_inputs.output.summary_md` 和 `index_inputs.output_placeholders` 替换占位符，不把创建文件动作交给子 agent。
